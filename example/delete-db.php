    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-12">
          ...
          <h3>Explanations</h3>
          <p>This code is the explanation for deleting existing database</p>

          <h3 class="mt-5">Code</h3>
          <p>This code illustrates - how to add data into table row.</p>
          <?php include __DIR__.'/codes/delete-db-code.php'; ?>
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-5 pb-2">
                ...
                <input class="form-control" name="db-name" id="name" type="text" placeholder="DB Name" required="required"
                  data-validation-required-message="Please enter name of the DB you want to delete.">
